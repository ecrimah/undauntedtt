...
const POST_META: Record<string, { title: string; excerpt: string; image: string; category: string; date: string }> = {
  '1': {
    title: 'The ultimate guide to online shopping in Ghana',
    excerpt: 'Practical tips for shopping safely online in Ghana — from spotting reliable stores to picking the right payment method.',
    image: '/page-hero-1.png',
    category: 'Shopping Tips',
    date: 'December 15, 2024',
  },
  '2': {
    title: '10 must-have products for your home this season',
    excerpt: 'Curated home upgrades that pair perfectly with your jewelry collection — small changes for a more refined space.',
    image: '/page-hero-4.png',
    category: 'Home & Living',
    date: 'December 12, 2024',
  },
  '3': {
    title: 'How to choose quality products: a buyer’s guide',
    excerpt: 'A practical framework for telling the well-made from the ordinary — and how to spot it when shopping online.',
    image: '/page-hero-5.png',
...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    ogImage: post.image,
    ogType: 'article',
    keywords: [post.category, 'jewelry', 'Ghana'],
  });
}
  ...
  const relatedPosts = [
    {
      ...
      image: id === '1' ? '/page-hero-4.png' : '/page-hero-1.png',
    ...
    },
    {
      ...
      image: id === '3' ? '/page-hero-1.png' : '/page-hero-5.png',
