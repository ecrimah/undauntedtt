  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        ...
        subtitle="Please read these terms carefully before using our website and services. Last updated: February 2026"
        backgroundImage="/page-hero-5.png"
      />
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              By accessing and using this website ({siteName}), you accept and agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use our website or services.
            </p>
