    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto">
          <Link href="/admin" className="flex items-center mb-8 px-2 cursor-pointer gap-3">
            <BrandLogo height={40} alt={`${process.env.NEXT_PUBLIC_WORDMARK || 'Undaunted TT'} admin`} />
            <span className="text-xs font-bold tracking-[0.2em] text-gray-500 uppercase">Admin</span>
          </Link>
