  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-brand-bronze hover:text-brand-caramel mb-6 whitespace-nowrap"
        >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              {notificationPermission === 'granted' && (
                <div className="bg-brand-ice border border-brand-caramel/40 rounded-xl p-4">
                  <p className="text-sm text-brand-bronze font-medium mb-2">You will receive notifications for:</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-brand-ice rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-rocket-line text-brand-bronze text-xl"></i>
                  <span className="font-semibold text-brand-bronze">Fast Loading</span>
                </div>
                <p className="text-sm text-brand-bronze">Instant page loads with smart caching</p>
              </div>
