          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
            <div className="mb-6 pb-6 border-b border-gray-200">
              <div className="flex items-center space-x-3 mb-4">
                <span className="px-3 py-1 bg-brand-caramel/25 text-brand-bronze rounded-full text-sm font-semibold whitespace-nowrap">
                  {article.category}
                </span>
            ...
            {!showFeedback ? (
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 py-3 px-6 border-2 border-brand-bronze text-brand-bronze hover:bg-brand-caramel hover:text-white rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                ...
                {wasHelpful ? (
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-brand-caramel/25 rounded-full mx-auto mb-4">
                      <i className="ri-check-line text-3xl text-brand-bronze"></i>
                    </div>
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-brand-caramel/25 rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-brand-bronze"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
              ...
              {relatedArticles.map((related) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <i className="ri-file-text-line text-xl text-brand-bronze"></i>
                    <div>
