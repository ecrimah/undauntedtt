...
export default function MobileSearchOverlay({ isOpen, onClose }: MobileSearchOverlayProps) {
  ...
  const searchSuggestions = [
    { name: 'Summer Floral Dress', category: 'Women\'s Clothing', price: 'GH₵289', image: '/placeholder.svg' },
    { name: 'Classic Leather Handbag', category: 'Bags', price: 'GH₵459', image: '/placeholder.svg' },
    { name: 'Designer Sunglasses', category: 'Accessories', price: 'GH₵199', image: '/placeholder.svg' }
  ];
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full pl-10 pr-10 py-3 bg-gray-100 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-brand-caramel"
              autoFocus
            />
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button 
                    ...
                    className="text-xs text-brand-bronze font-medium whitespace-nowrap"
                  >
                    Clear All
                  </button>
                </div>
              ...
              {searchSuggestions.map((product, index) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-semibold text-brand-bronze mt-1">{product.price}</p>
                  </div>
                </Link>
              ))}
            </div>
