...
const mockTickets = [
  ...
  {
    id: 'TKT-2024-0032',
    subject: 'Delivery delayed for order #ORD-EXAMPLE-001',
...
export default function MyTicketsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'open': return 'bg-brand-caramel/25 text-brand-bronze';
      case 'in_progress': return 'bg-amber-100 text-amber-700';
      case 'resolved': return 'bg-brand-caramel/25 text-brand-bronze';
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      case 'normal': return 'text-brand-bronze';
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/support/ticket"
              className="bg-brand-bronze hover:bg-brand-caramel text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
            >
          ...
          {filteredTickets.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm p-12 text-center">
              ...
              <Link
                href="/support/ticket"
                className="inline-block bg-brand-bronze hover:bg-brand-caramel text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
              >
            ...
            <div className="space-y-4">
              {filteredTickets.map((ticket) => (
                <Link
                  ...
                  className="block bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all border-2 border-transparent hover:border-brand-caramel"
                >
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-brand-caramel/25 rounded-lg mb-4">
                <i className="ri-time-line text-2xl text-brand-bronze"></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">Response Time</h3>
              <p className="text-2xl font-bold text-brand-bronze mb-1">24 hours</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <p className="text-2xl font-bold text-brand-bronze mb-1">95%</p>
