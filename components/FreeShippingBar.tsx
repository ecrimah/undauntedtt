...
export default function FreeShippingBar({ currentAmount, threshold = 200 }: FreeShippingBarProps) {
  ...
  return (
    <div className={`rounded-lg p-4 mb-4 ${
      isQualified 
        ? 'bg-gradient-to-r from-brand-caramel to-teal-500 text-white' 
      ...
      <div className="relative">
        ...
        {isQualified && (
          <div className="absolute right-0 top-1/2 -translate-y-1/2 -mr-1">
            <div className="w-6 h-6 flex items-center justify-center bg-white rounded-full text-brand-bronze">
