  ...
  const handleExportData = async () => {
    ...
    setTimeout(() => {
      const userData = {
        ...
        orders: [
          { id: 'ORD-EXAMPLE-001', date: '2024-03-15', total: 129.99 },
          { id: 'ORD-EXAMPLE-002', date: '2024-03-20', total: 89.99 }
        ],
        addresses: [
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        <div className="bg-brand-ice border border-brand-caramel/40 rounded-xl p-4">
          <div className="flex gap-3">
            <i className="ri-shield-check-line text-xl text-brand-bronze flex-shrink-0 mt-0.5"></i>
            <div>
              <h3 className="font-semibold text-brand-bronze mb-1">Your Privacy Matters</h3>
