...
/**
 * Moolre callback: JSON body with status, code, message, data (payer phone, amount, externalref, etc.), secret, ts.
 * Field names and shapes follow the provider’s documentation.
 */
